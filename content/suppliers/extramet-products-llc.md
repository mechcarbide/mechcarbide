...
display_name: Extramet Products
name: EXTRAMET Products, LLC
structured_description: >
  Extramet Products, founded in Switzerland (1980) and headquartered in Latrobe,
  PA, is a leading supplier of premium Tungsten Carbide materials. The company
  specializes in 'Blank Preparation,' providing precision Ground Rods and CNC
  Step Blanks to reduce toolmaker lead times. Core capabilities include
  high-volume Centerless Grinding (tolerances to 0.0002 inches) and CNC
  Cylindrical Grinding. Extramet serves critical sectors including Aerospace
  (composite machining), Medical, and Energy with ISO 9001:2015 certified
  quality.
...
structured_data:
  ...
  addressRegion: Pennsylvania
  addressCountry: United States
  structured_description: Extramet Products, founded in Switzerland (1980) and
    headquartered in Latrobe, PA, is a leading supplier of premium Tungsten
    Carbide materials. The company specializes in 'Blank Preparation,' providing
    precision Ground Rods and CNC Step Blanks to reduce toolmaker lead times.
    Core capabilities include high-volume Centerless Grinding (tolerances to
    0.0002 inches) and CNC Cylindrical Grinding. Extramet serves critical
    sectors including Aerospace (composite machining), Medical, and Energy with
...
**Carbide Rods:** Solid Rods, Coolant Rods (Straight/Helical Holes), Tubes.

**Pre-ground Blanks:** Step Blanks, Formed Blanks, Cut-to-Length Rods.

**Wear Parts:** Valve Stems/Seats, Nozzles, Shafts, Bearings.
...
**Service Regions:** Global (Strong presence in North America & Europe)

*[[View Official Carbide Grade Chart](https://extramet.net/products/tungsten-carbide-grades/)]*
